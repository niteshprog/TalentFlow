...
from .tools.input_processor_tools import scenario_decider, input_validator
...
input_tools = ToolNode([scenario_decider, input_validator])
...
agent_builder.add_node("input_tools", input_tools)
